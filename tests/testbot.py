...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await context.bot.send_message(chat_id=query.message.chat_id, text='Please complete your payment:', reply_markup=reply_markup)
...
def main():
    ...
    application.add_handler(CommandHandler("purchase", start_purchase))
